...
///
/// A true `async fn` (every OTHER command in this file is a sync `fn` tagged
...
/// fn`". The guard test at the bottom of this file only scans literal
/// `pub fn open_*` lines, so this fn is intentionally exempt from it.
#[tauri::command]
