...
use crate::logging::{init_daemon_file_logger, install_panic_hook};

pub use crate::logging::default_log_filter;
...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::token_source::token_stats_by_source,
            ipc::chat_drain,
            ipc::chat_drains,
