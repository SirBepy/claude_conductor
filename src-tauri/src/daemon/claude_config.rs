...
pub(crate) fn base_claude_args(resume_id: Option<&str>, session_id: &str, model: &str, effort: &str, remote: bool, fork: bool) -> Vec<String> {
    ...
    // frame, so a card per session bought nothing. Space-separated per the
