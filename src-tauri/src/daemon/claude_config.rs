...
///
/// Also nudges AskUserQuestion body formatting: this card's markdown+split
/// rendering (`permission-modal/question-ui.ts`'s `splitAsk()`) only exists
/// here, not the bare CLI's own UI - same scoping reason as the nudge above.
///
